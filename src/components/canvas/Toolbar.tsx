...
export function Toolbar({
  ...
  return (
    <div className="flex flex-col gap-2 rounded-2xl border border-border bg-white p-3 shadow-panel">
      <p className="text-xs text-ink-muted">
        Click a shape below to add it precisely, or draw free-hand directly on the canvas.
      </p>
